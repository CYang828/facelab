...
def multi_step_lr(initial_learning_rate, lr_steps, lr_rate, name='MultiStepLR'):
...
def multi_step_warmup_lr(initial_learning_rate, lr_steps, lr_rate,
    ...
    return PiecewiseConstantWarmUpDecay(
        ...
        min_lr = min_lr, name = name)


def cosine_annealing_lr_restart(initial_learning_rate, t_period, lr_min):
...
if __name__ == "__main__":
    lr_scheduler = multi_step_warmup_lr(1e-2, [5500, 6800], 0.1,
